...
namespace BookShop.Migrations
{
    ...
    [Migration("20231025184207_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShop.Data.Models.Categories", b =>
                {
            ...
            modelBuilder.Entity("BookShop.Data.Models.Category_requests", b =>
                {
            ...
            modelBuilder.Entity("BookShop.Data.Models.Order_items", b =>
                {
            ...
            modelBuilder.Entity("BookShop.Data.Models.Orders", b =>
                {
                    b.Property<int>("order_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShop.Data.Models.Products", b =>
                {
                    b.Property<int>("product_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            category_id = 1,
                            description = "<p>Nhìn lại lịch sử dân tộc và lịch sử Phật giáo kể từ khi được truyền vào nước ta, điều khẳng định là trên cả ba bình diện dựng nước, giữ nước và mở nước cũng như trong đấu tranh chống bất công và cường quyền, Tăng Ni và Phật Tử Việt Nam đã khẳng định mình là một bộ phận gắn bó chặt chẽ với dân tộc, đã góp tiếng nói và công sức vào cuộc đấu tranh vì Độc lập, Tự do của Tổ quốc, vì cuộc sống và hạnh phúc của nhân dân. </p><p>Cuộc vận động của Phật giáo Việt Nam năm 1963 thêm một lần nữa đã chứng minh điều đó.</p><p>Phật   giáo  đã có bề dày lịch sử gần hai chục thế kỷ. Trong quá trình đó  Phật   giáo  Việt Nam đã xây dựng cho mình truyền thống yêu nước, gắn bó dân tộc, góp phần quan trọng trong việc xây dựng nền văn hóa dân tộc, trong tư tưởng, đạo đức, tâm lý lối sống của nhân dân. Dù ở trong bất kỳ hoàn cảnh lịch sử nào,  Phật   giáo  Việt Nam chưa bao giờ tự tách mình khỏi khối cộng đồng dân tộc. Trong lầm than nô lệ,  Phật   giáo  Việt Nam đã cùng với dân tộc vùng lên đánh đổ ách thống trị ngoại bang. Trong sự hưng thịnh của đất nước Việt Nam có sự góp sức của  Phật   giáo . Điều đó giải thích tại sao “ Phật   giáo  từ hàng nghìn năm nay đã chiếm được một chỗ đứng khá vững chắc trong lòng của hàng triệu con người” và “có thể nói hai ngàn năm  Phật   giáo  Việt Nam là hai ngàn năm  Phật   giáo  nhập thân với dân tộc”, đúng như Chủ tịch Hồ Chí Minh nói: “ Phật   giáo  Việt Nam với dân tộc như hình với bóng, tuy hai mà một”.</p>",
            ...
            modelBuilder.Entity("BookShop.Data.Models.Users", b =>
                {
                    b.Property<int>("user_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShop.Data.Models.Order_items", b =>
                {
                    b.HasOne("BookShop.Data.Models.Orders", "Order")
                        .WithMany("order_Items")
                        .HasForeignKey("order_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookShop.Data.Models.Products", "Product")
                        .WithMany("order_Items")
            ...
            modelBuilder.Entity("BookShop.Data.Models.Orders", b =>
                {
                    b.HasOne("BookShop.Data.Models.Users", "User")
                        .WithMany("orders")
            ...
            modelBuilder.Entity("BookShop.Data.Models.Products", b =>
                {
                    b.HasOne("BookShop.Data.Models.Categories", "Category")
                        .WithMany("products")
